...
const PaymentSuccess: React.FC = () => {
  ...
  const orderInfo = isCOD
    ? codOrderData?.orderInfo
    ...
    <div className="container mx-auto p-6">
      ...
      {updateError && !isCOD && (
        <div className="text-center mb-4">
          <p className="text-red-600">{lang("warning", updateError)}</p>
        </div>
      )}
      ...
      <div className="border rounded-lg p-6 shadow-lg bg-white hover:shadow-xl transition-shadow">
        ...
        <p className="text-gray-600 mt-2">
          ...
          {isCOD ? lang("cash-on-delivery") : lang("qr-code")}
        </p>
        {orderInfo && (
          <p className="text-gray-600 mt-2">
