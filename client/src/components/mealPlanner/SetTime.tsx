...
const SetTime: React.FC<SetTimeProps> = ({ meal, date, onSubmit, onClose, time }) => {
  ...
  const updateEndTime = (startTime: string) => {
    ...
    setEndTime(formatDateWithLocale(calculatedEndTime, "HH:mm"));
  };
  ...
  const handleEndTimeChange = (newEndTime: string) => {
    ...
    setStartTime(formatDateWithLocale(calculatedStartTime, "HH:mm"));
  };
    ...
    <div className="modal modal-open">
      <div className="modal-box w-11/12 max-w-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold">{lang("set-meal-time")}</h2>
        ...
        <p className="text-sm text-gray-500 mb-6">
          {lang("set-meal-time-desc")}
        </p>

        {/* Time Selection */}
        <div className="bg-gray-100 p-4 rounded-lg mb-6">
          <div className="flex justify-between items-center">
            <h3 className="text-center font-semibold">{date.toLocaleDateString(langCode, {
              weekday: "long",
              year: "numeric",
              month: "long",
              day: "numeric",
          ...
          <div className="flex justify-between items-center mt-4">
            <div>
              <p className="font-semibold uppercase">{lang("start")}</p>
            ...
            <div>
              <p className="font-semibold uppercase">{lang("serve")}</p>
