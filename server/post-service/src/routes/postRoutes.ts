...
import {
  getPostByUserFollowingController,
  getPostLikesByUserController,
  getSavedPostsByUserController,
  isLikedPostByUserController,
  isSavedPostByUserController,
  likeOrUnlikePostController,
  saveOrUnsavedPostController,
} from "../controllers/postAction.controller";
import {
  createMadeRecipeController,
  deleteMadeRecipeController,
  getMadeRecipeByIdController,
  getMadeRecipeOfPostController,
  updateMadeRecipeController,
} from "../controllers/madeRecipe.controllers";
import {
  createCommentController,
  deleteCommentController,
  getCommentByIdController,
  getCommentByPostIdController,
  likeOrUnlikeCommentController,
  updateCommentController,
} from "../controllers/comment.controllers";
import {
  addIngredientToShoppingListController,
  checkPostInShoppingListController,
  getShoppingListController,
  removeIngredientFromShoppingListController,
  removeIngredientsFromShoppingListController,
  removePostFromShoppingListController,
  updateIngredientInShoppingListController,
} from "../controllers/shoppingList.controllers";
import {
  addMealController,
  checkPostInUnscheduledMealController,
  getMealPlannerController,
  removeMealController,
  scheduleMealController,
} from "../controllers/mealPlanner.controllers";
import {
  addProductToCartController,
  searchProductsController,
  createReviewProductController,
  getAllProductsController,
  getCartController,
  getProductByPostIdController,
  removeProductFromCartController,
  createOrderController,
  getOrdersByUserController,
  getOrderOfSellerController,
...
postRouter.get("/dashboard", tokenValidate, getDashboardStatisticsController);
// product
postRouter.patch(
  "/product/addToCart",
  tokenValidate,
...
postRouter.get(
  "/product/getProductByPostId/:postId",
  tokenValidate,
  getProductByPostIdController
);
postRouter.patch(
...
// shoppinglist
postRouter.patch(
  "/shoppingList/removeIngredients",
  tokenValidate,
  removeIngredientsFromShoppingListController
);
postRouter.post(
